<? if(!defined('B_PROLOG_INCLUDED') || B_PROLOG_INCLUDED !== true) die(); ?>
            ...
            <div class="form-group animated-labels">
                ...
                <div class="input input-with-margin-top input-with-margin-bottom">
                    <input
                            disabled="disabled"
                            placeholder="Страна *"
                            data-code="" autocomplete="off"
                            type="text" id="POPUP_COUNTRY"
                            name="COUNTRY"
                            class="country form-control required field-to-be-fill"
            ...
            <div class="form-group animated-labels">
                <div class="input input-with-margin-top input-with-margin-bottom">
                    <input
                            ...
                            id="POPUP_REGION"
                            name="REGION"
                            class="region form-control required field-to-be-fill"
                            value=""
                            aria-required="true"
                    >
            ...
            <div class="form-group animated-labels">
                <div class="input input-with-margin-top input-with-margin-bottom">
                    <input
                            ...
                            id="POPUP_CITY"
                            name="CITY"
                            class="city form-control required field-to-be-fill"
                            value="Москва"
                            aria-required="true"
                    >
        ...
        <div data-sid="HOUSE" class="col-md-12 col-sm-12 col-xs-12 no-padding-on-mobile">
            <div class="form-group animated-labels">
                <div class="input input-with-margin-top input-with-margin-bottom">
                    <input placeholder="Улица, Дом *" data-settlement="" data-city="" data-code="" autocomplete="off" type="text" id="POPUP_HOUSE" name="HOUSE" class="house form-control required field-to-be-fill" value="" aria-required="true">
